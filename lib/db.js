...
const stmts = {
    ...
    insertMessage: db.prepare(
        'INSERT INTO messages (conversation_id, sender_id, type, content, file_name, file_size, mime, duration, created_at, sys_key, sys_args) '
        + 'VALUES (?,?,?,?,?,?,?,?,?,?,?)'),
