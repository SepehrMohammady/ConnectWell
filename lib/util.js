...
// A caption travels as a percent-encoded request HEADER beside the raw file body,
// so its budget is a header line, not a body. encodeURIComponent turns each
// non-ASCII UTF-8 byte into three ASCII characters — Persian costs 6 bytes per
// character — so 500 characters is ~4.5 KB worst case, comfortably inside nginx's
// default 8k per header line. Raising this materially means also raising
// large_client_header_buffers in deploy/nginx-connectwell.conf.
...
module.exports = {
    ...
    classifyMime, INLINE_MIMES, sanitizeFilename, sniffImage, REACTIONS, MAX_CAPTION_LEN,
};
